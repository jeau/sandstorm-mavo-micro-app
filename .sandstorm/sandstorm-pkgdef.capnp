...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "3ycwq0gwhddfr91fzx5mv1krujx40z6vkrt1xe7knv4yqxmv2uhh",
  ...
  manifest = (
    ...
    appVersion = 0.1,  # Increment this for every release.
    ...
    metadata = (
      ...
      shortDescription = (defaultText = "Build apps \"à la carte\""),
